  ...
  export default {
    ...
    computed: {
      ...
      cover() {
        ...
        const qwq = covers[parseInt(Math.random() * (6 + 1))]
        return covers[parseInt(Math.random() * (6 + 1))]

        // const awa = this.$themeConfig.covers
        // const qwq = this.$themeConfig.covers[new Date().getDay()]
        // debugger
      ...
      pageCover() {
        ...
        return this.$page.frontmatter.cover || covers[0]
      },
      shouldShowNavbar() {
