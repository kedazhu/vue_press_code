...
export default {
  data () {
    return {
      popupWindowStyle: {},
      isPC: true,
      sg_imgUrl: require('../images/q7.png'),
      vue_imgUrl: require('../images/q4.jpg'),
      vuepress_imgUrl: require('../images/q6.jpg'),
      el_imgUrl: require('../images/w2.jpg'),
      vuepress_emm_imgUrl: require('../images/q5.jpg'),
    }
  },
  mounted () {
  ...
  computed: {
    dataAddColor () {
      ...
      if (friendLink && friendLink.length > 0) {
        ...
        friendLink[0].logo = this.sg_imgUrl
        friendLink[1].logo = this.vue_imgUrl
        friendLink[2].logo = this.vuepress_imgUrl
        friendLink[3].logo = this.el_imgUrl
        friendLink[4].logo = this.vuepress_emm_imgUrl
        return friendLink
      }
      return []
    }
